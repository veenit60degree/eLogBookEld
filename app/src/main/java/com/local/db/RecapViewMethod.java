        ...
        try {
            for(int i = 0 ; i < recapViewArray.length() ; i++){
               ...
               // if(DriverLogArray.length() > 0) {
                    ...
                    recapJson.put(ConstantsKeys.CycleDaysDriverLogModel, json.getJSONArray(ConstantsKeys.CycleDaysDriverLogModel)); //json.getString(ConstantsKeys.CycleDaysDriverLogModel)
