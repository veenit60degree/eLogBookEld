...
public class PermissionInfoDialog extends Dialog {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dataList.add(new PermissionInfoModel("Phone Number", "Arethos Logistics System (ALS) uses the Phone and Sim Number information for mapping of ELD Devices with Trucks. Furthermore, Phone Number information is used to troubleshoot the device in case of any network problem. Phone UICCID is used to check data utilization of an individual SIM to provide better Fleet Management Solution.", R.drawable.permsn_phone));
