...
public class UnidentifiedDutyStatusAdapter extends RecyclerView.Adapter<UnidentifiedDutyStatusAdapter.CustomViewHolder> {
    ...
    public UnidentifiedDutyStatusAdapter(Context c, List<CanadaDutyStatusModel> list) {
        mContext = c;
        itemsList = list;
