...
public class GridAdapter extends BaseAdapter{
    ...
    public GridAdapter(Context c, boolean isChecked, boolean isSelectAllBtnClicked, List<PrePostModel> list, ArrayList<String> selectedItemArray,  ArrayList<Integer> selectedItemIdArray) {
        mContext = c;
        itemsArray = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.checkboxInspection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                InspectionFragment.trailerInspectionTV.performClick();
            }
        });
