...
public class UnidentifiedEnginePowerAdapter extends RecyclerView.Adapter<UnidentifiedEnginePowerAdapter.CustomViewHolder> {
    ...
    public UnidentifiedEnginePowerAdapter(Context c, List<CanadaDutyStatusModel> list) {
        mContext = c;
        itemsList = list;
