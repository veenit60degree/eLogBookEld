...
public class EldFragment extends Fragment implements View.OnClickListener{
    ...
    ImageView editTrailorIV, editTruckIV, eldMenuBtn, inboxImageView;
    ...
    Button sendReportBtn, certifyLogBtn, yardMoveBtn, personalUseBtn;
    ...
    AlertDialog saveJobAlertDialog, yardMovePersonalUseAlert;
    ...
    void initView(View view) throws JSONException {
        ...
        certifyLogBtn = (Button) view.findViewById(R.id.certifyLogBtn);
...
*/
    ...
    void showTimeZoneAlert(boolean isConnected){
        if (DRIVER_ID.length() > 0) {
            ...
            try {
                ...
                timeZoneDialog = new TimeZoneDialog(getActivity(), isTimeZoneValid);
                timeZoneDialog.show();
...
// ----------------- Get Date Difference ---------------------
    ...
    void saveInfo(String jobStatus, boolean isSaveJob, boolean isLoad, boolean IsRecap) {
        ...
        // Global.SaveFileInSDCard(DriverJsonArray.toString(), getActivity());
        ...
        switch (v.getId()) {
            ...
            case R.id.yardMoveBtn:
                ...
                if(sharedPref.IsYardMoveAllowed(getActivity())) {
                   ...
                   // Global.EldScreenToast(OnDutyBtn, getResources().getString(R.string.yard_move_not_allowed), getResources().getColor(R.color.colorVoilation));
                }
            ...
            case R.id.rightMenuBtn:
                ...
                GetSavePreferences();
                onResumeDataSet(Global.isConnected(getActivity()));
...
*/
    ...
    private boolean isCertifySignPending(boolean isOnCreate ){
        ...
        String title                      = "<font color='" + colorCode + "'><b>Reminder !!</b></font>";
        ...
        public void JobBtnReady(String TrailorNo, String reason, String type, boolean isUpdatedTrailer, int ItemPosition,EditText TrailorNoEditText, EditText ReasonEditText) {
            ...
            try {
                if (type.equals("on_duty")) {
                    ...
                    HideKeyboard(TrailorNoEditText);
                    ...
                    try {
                        ...
                        if (!isFirst && obj.getString("Status").equals("true")) {
                            ...
                            if (Message.equalsIgnoreCase("Duplicate Records")) {
                                ...
                                if (isLoad) {
                                    Global.EldScreenToast(OnDutyBtn, obj.getString("Message"), getResources().getColor(R.color.colorVoilation));
                                }
            ...
            if (status.equalsIgnoreCase("true")) {
                ...
                try {
                    if (!obj.isNull("Message")) {
                        ...
                        String Message = obj.getString("Message");
                        if (Message.equals("Device Logout") && DriverJsonArray.length() == 0) {
                            LogoutUser();
                        } else {
                            if (DriverJsonArray.length() > 0) {
                                SyncUserData();
            ...
            switch (flag) {
                ...
                case GetDriverLog18Days:
                    if (IsRefreshedClick) {
                        ...
                        IsRefreshedClick = false;
                        if(getActivity() != null) {
                            Global.EldScreenToast(OnDutyBtn, "Data synchronization failed", getResources().getColor(R.color.colorVoilation));
                        }
                    }
