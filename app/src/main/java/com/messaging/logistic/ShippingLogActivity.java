...
import com.messaging.logistic.fragment.ShippingLogFragment;

public class ShippingLogActivity extends FragmentActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ShippingLogFragment detailFragment = new ShippingLogFragment();
