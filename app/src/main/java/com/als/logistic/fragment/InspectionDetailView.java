            ...
            try {
                ...
                if (obj.getString("Status").equals("true")) {
                    if(Message.equals("Sucess")) {
                        ...
                        Globally.EldScreenToast(changeLocBtn, "Location updated successfully", UILApplication.getInstance().getThemeColor());
                        ...
                        Globally.EldScreenToast(changeLocBtn, Message, UILApplication.getInstance().getThemeColor());
                    }
