...
class ItemMainLayout extends FrameLayout {
    ...
    /* Determine whether the current slide-out, if it is slip-out, it is SCROLL_STATE_OPEN,
    then excessive sliding will not trigger the slideOpen interface,
    the same reason SCROLL_STATE_CLOSE */
    ...
    /* Need scroll back status */
    protected static final int SCROLL_BACK_CLICK_NOTHING = 0;
    protected static final int SCROLL_BACK_CLICK_OWN = 1;//Click to item
    protected static final int SCROLL_BACK_ALREADY_CLOSED = 2;
    protected static final int SCROLL_BACK_CLICK_MENU_BUTTON = 3;//Click on the button of menu
    ...
    /* The total width of the button in the child control */
    ...
    /*  Whether the control slides */
    private boolean mIsMoving = false;
    /* Is it going to slip (over) */
    private boolean mWannaOver = true;
    /* The minimum sliding distance is exceeded, and it is considered to start sliding.*/
