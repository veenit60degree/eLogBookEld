...
public class BleManager {
    ...
    private static final int DEFAULT_CONNECT_RETRY_INTERVAL = 10000;
    ...
    public void notify(BleDevice bleDevice,
                       String uuid_service,
                       String uuid_notify,
                       BleNotifyCallback callback, boolean useCharDesc) {
        notify(bleDevice, uuid_service, uuid_notify, useCharDesc, callback);
    }
    ...
    private void refreshDeviceCache(BleDevice bleDevice) {
        try {
